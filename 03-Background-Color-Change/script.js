var color = ["#222f3e", "#f368e0", "#ee5253", "#882611", "#118388", 
"#DAF7A6", "#DAE437", "#FF5733"];
var index = 0;
document.querySelector("button").addEventListener('click',function(){
    index = index < color.length ? ++index : 0;
    document.querySelector("body").style.background = color[index]
})
...
var path = "butterfly.png" // URL of your image
